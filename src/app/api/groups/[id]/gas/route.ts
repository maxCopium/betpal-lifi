 ...
 *
 * Returns the group wallet's ETH balance on Base (for gas).
 * Any group member can check this. Gas is needed for payouts
 * (vault redeem + USDC transfer). Members fund the wallet manually
 * by sending Base ETH to the wallet address.
 */
